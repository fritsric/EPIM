...
public class PdfDocument extends WordDocument{
    ...
    public static PdfDocument convertDocxToPdf(WordDocument doc){
        return new PdfDocument(doc.getCreateFactory(), doc.getDocumentBody(), doc.getWmlPackage(), doc.getHeader(), doc.getFooter());
    }
}
